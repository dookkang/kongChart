...
/*        console.log('1 481:'+this.minZValue);
        console.log('2:'+this.maxZValue);  */   
        //this.minZValue = 0;
        //this.maxZValue = 100;
...
/*    this.tick = function(){
   ...
   /*     console.log('1:'+this.minZValue);
    ...
    this.nice_num = function(x, round){
        ...
        //console.log('sum:'+nf * Math.pow(10, exp));
        return nf * Math.pow(10, exp);
    }
    
    this.calculateZScale = function(){
    	//console.log('calculateZScale');
...
GLSurface.prototype.draw = function(){
	//console.log('GLSurface.prototype.draw1');
    this.currentShader = this.shaderProgram;
    this.gl.useProgram(this.currentShader);
