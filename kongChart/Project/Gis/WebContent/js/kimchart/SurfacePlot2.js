...
SurfacePlot.prototype.draw = function(data, options, basicPlotOptions, glOptions,_canvas){
                ...
                for (i = 0, xPos = -0.5; i < this.numXPoints; i++, xPos += xDivision) {
                    for (j = 0, yPos = 0.5; j < this.numYPoints; j++, yPos -= yDivision) {
                        ...
                        if (this.useWebGL) 
                            ...
                            colIndex = j;
                      //여기
                        dataframe[index] = new Point3D(y, x, this.dataToRender[k][i][colIndex]); // Reverse the y-axis to match the non-webGL surface.
                        index++;
                    }
                }
            ...
            for (i = 0, xPos = -0.5; i < this.numXPoints; i++, xPos += xDivision) {
                for (j = 0, yPos = 0.5; j < this.numYPoints; j++, yPos -= yDivision) {
                    ...
                    if (this.useWebGL) 
                        ...
                        colIndex = j;
                  //여기
                    data3ds[index] = new Point3D(y, x, this.dataToRender[i][colIndex]); // Reverse the y-axis to match the non-webGL surface.
                    index++;
                }
            }
        }
...
JSSurfacePlot.DEFAULT_X_ANGLE_WEBGL = -50;
JSSurfacePlot.DEFAULT_Y_ANGLE_WEBGL = -20;
