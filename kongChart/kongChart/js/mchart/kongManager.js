...
function createSeries(_s_name,_s_chartType,_data){
	...
	if(Array.isArray(_data)){
		fObj1 = chartUtil.formatData_profile2(_data);
	}else{
		fObj1 = _data;
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function chart2(){
			...
			option.unitLabel_Hori			= 'Avrage Day Temprature';
			option.unitLabel_Verti			= 'Sales(In Usd)';
			option.chartTitle				= '[Sales Of Beer & Ice-cream vs Temprature Los Angeles Topanga]';	
	...
	function chart5(){
			...
			var aSeries 	= createSeries('any sereis1','line',chartUtil.formatData_profile2(data5_1,false,yMax,yMin,divNum));//3번,4번argu->max=null,min=null주면 동적으로 구함
			aSeries.s_unit	='개';//툴팁에 표시될 Y값의단위
			...
			var aSeries 	= createSeries('any sereis2','line',chartUtil.formatData_profile2(data5_2,false,yMax,yMin,divNum));//3번,4번argu->max=null,min=null주면 동적으로 구함
			aSeries.s_unit	='개';//툴팁에 표시될 Y값의단위
			...
			var aSeries 	= createSeries('any sereis3','line',chartUtil.formatData_profile2(data5_3,false,yMax,yMin,divNum));//3번,4번argu->max=null,min=null주면 동적으로 구함
			aSeries.s_unit	='개';//툴팁에 표시될 Y값의단위
			aSeries.s_sizeDefault = 3;//점의 크기
			aSeries.s_shape='circle';//점의 모양
	...
	function chart6(){
			...
			/* 2번 시리즈 [주의 : createSeries사용시 이름이 반드시 달라야함!!!]*/
			var aSeries 	= createSeries('any sereis B','line',data6_2);//3번,4번argu->max=null,min=null,divNum=null주면 동적으로 구함
			aSeries.s_unit	='개';//툴팁에 표시될 Y값의단위
			aSeries.s_sizeDefault = 2;//점의 크기
			aSeries.s_shape='rect';//점의 모양
			aSeries.s_color='rgba(231,158,228,1)';//시리즈의 색상, (0,128,192)색은 블루
	...
	function chart15(){
			...
			option.toFixedY						= 1;//소수점을 반드시 표현해야하는 축이므로
			////////////////////////////////////////////////////////////////////////////////////////////////////			
